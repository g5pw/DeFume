...
IMAGE_TYPE=debug
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/FanCtlRemote.X.${IMAGE_TYPE}.cof
else
...
#######################################################################
MP_CC=/Applications/microchip/HI-TECH/picc/9.82/bin/picc
# MP_BC is not defined
MP_AS=/Applications/microchip/HI-TECH/picc/9.82/bin/picc
MP_LD=/Applications/microchip/HI-TECH/picc/9.82/bin/picc
MP_AR=/Applications/microchip/HI-TECH/picc/9.82/bin/picc
# MP_BC is not defined
MP_CC_DIR=/Applications/microchip/HI-TECH/picc/9.82/bin
# MP_BC_DIR is not defined
MP_AS_DIR=/Applications/microchip/HI-TECH/picc/9.82/bin
MP_LD_DIR=/Applications/microchip/HI-TECH/picc/9.82/bin
MP_AR_DIR=/Applications/microchip/HI-TECH/picc/9.82/bin
# MP_BC_DIR is not defined

.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/FanCtlRemote.X.${IMAGE_TYPE}.cof
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/FanCtlRemote.X.${IMAGE_TYPE}.cof: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE) -odist/${CND_CONF}/${IMAGE_TYPE}/FanCtlRemote.X.${IMAGE_TYPE}.cof -mdist/${CND_CONF}/${IMAGE_TYPE}/FanCtlRemote.X.${IMAGE_TYPE}.map --summary=default,-psect,-class,+mem,-hex --chip=$(MP_PROCESSOR_OPTION) -P --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,+stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=default,+asm,-asmfile,+speed,-space,-debug,-9 -D__DEBUG --debugger=pickit2 -N31 --warn=9  --double=24 --float=24 --addrqual=ignore --mode=pro --output=default,-inhx032 -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s" ${OBJECTFILES}  
	${RM} dist/${CND_CONF}/${IMAGE_TYPE}/FanCtlRemote.X.${IMAGE_TYPE}.hex
else
dist/${CND_CONF}/${IMAGE_TYPE}/FanCtlRemote.X.${IMAGE_TYPE}.cof: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
